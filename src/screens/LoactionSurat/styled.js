...
export const MainSection = styled("div")`
  background-image: url(${suratmain});
  width: 100%;
  height: auto;
  ...
  @media only screen and (max-width: 600px) {
    background-image: url(${suratmainMobile});
  ...
  @media only screen and (min-width: 768px) {
    background-image: url(${suratmainTablate});
    background-size: cover;
    height: 630px;
    .mainBannerHeading {
      font-size: 32px;
...
export const UspSection = styled("div")`
  ...
  .Main_cart:hover .cart_title,
  .Main_cart:hover .cart_description {
    color: #fff;
  }
  .Main_cart:hover .inner_icon {
    background-color: #fff;
  }
  .Main_cart:hover .svgs path {
    fill: #024638;
    stroke: #024638;
  }
  .cart_title {
