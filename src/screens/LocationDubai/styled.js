...
export const MainSection = styled("div")`
  background-image: url(${dubaimain});
  width: 100%;
  height: auto;
  ...
  @media only screen and (max-width: 600px) {
    background-image: url(${dubaimobile});
  ...
  @media only screen and (min-width: 768px) {
    background-image: url(${dubaitablet});
    background-size: cover;
    height: 630px;
    .mainBannerHeading {
      font-size: 34px;
...
export const UspSection = styled("div")`
      ...
      .usp_icon:hover svg path{
        fill:#fff;
      }
      .main-cart .description .title{
        color: #024638;
        font-family: Prumo Deck;
        font-size: 20px;
        font-weight: 500;
      ...
      .main-cart .description .inner_description{
        color: #3C3C3B;
        font-family: IBM Plex Sans;
        font-size: 16px;
        font-weight: 400;
