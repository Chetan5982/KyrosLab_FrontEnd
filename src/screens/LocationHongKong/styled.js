...
export const MainSection = styled("div")`
  background-image: url(${hongkongmain});
  width: 100%;
  height: auto;
  ...
  @media only screen and (max-width: 600px) {
    background-image: url(${hongkongmobile});
  ...
  @media only screen and (min-width: 768px) {
    background-image: url(${hongkongtablet});
    background-size: cover;
    height: 630px;
    .mainBannerHeading {
      font-size: 30px;
...
export const MapSection = styled("div")`
  .mapimg {
    background-image: url(${hongkongmap});
    width: 100%;
    height: 85vh;
    background-repeat: no-repeat;
    background-position: center;
