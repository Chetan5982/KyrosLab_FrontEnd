...
export const metadata = {
  title: "Lab Grown Diamond Manufacturer in Hong Kong - CVD Diamonds - Bhanderi",
  description:
...
const Layout = ({ children }) => {
  const schemaData = {
      ...
      "image": "https://d1tmxmmhy79644.cloudfront.net/LocationHongKong/hongkongofficesec.png",
      "@id": " https://blgdlab.com/",
      "url": "https://blgdlab.com/lab-grown-diamonds-manufacturer-hong-kong",
      "telephone": "+852 2723 1243",
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "1006, Hung Hom Commercial Center Tower B, 37 Ma Tau Wai Road, Hung Hom",
